      ...
      <DashboardLayout>
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Manage all builder accounts in the system</p>
          </div>
      ...
      <DashboardLayout>
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Error Loading Builders</h1>
        ...
        {activeTab === 'pending' ? (
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">Builders Waiting for Approval</h2>
            ...
            {pendingLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">All builder registrations have been reviewed.</p>
              </div>
            ) : (
