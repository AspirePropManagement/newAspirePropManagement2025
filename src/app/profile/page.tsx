      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-6">
        <div className="w-full max-w-none px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 xl:grid-cols-16 gap-6 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-4 xl:col-span-5 bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-xl border border-blue-100 p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex flex-col items-center text-center mb-6">
                  <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center mb-4 shadow-lg">
              ...
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                  ...
                  {!isEditing && (
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                      Edit Profile
                    </button>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-700">
                      ...
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-gray-50 focus:bg-white"
                      placeholder="Enter your first name"
                        />
                      ) : (
                    <div className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
                      <span className="text-gray-900 font-medium">{user.first_name || 'Not provided'}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-700">
                    ...
                    <div className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
                      <span className="text-gray-900 font-medium">{user.last_name || 'Not provided'}</span>
                    </div>
                  )}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full px-4 py-3 bg-gray-100 rounded-xl border border-gray-200 cursor-not-allowed">
                  ...
                  <>
                    <div className="space-y-2">
                      <label className="block text-sm font-semibold text-gray-700">
                        ...
                        <div className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
                          <span className="text-gray-900 font-medium">{agentData.firm_name || 'Not provided'}</span>
                        </div>
                        )}
                      </div>
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-semibold text-gray-700">
                        ...
                        <div className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
                          <span className="text-gray-900 font-medium">{agentData.rera_id || 'Not provided'}</span>
                        </div>
                        )}
                    </div>
                  </>
                ...
                <div className="flex space-x-4 pt-8 border-t border-gray-100 mt-8">
                    ...
                    className="px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                      >
                        Save Changes
                      </button>
                      <button
            ...
            <div className="lg:col-span-12 xl:col-span-16 bg-gradient-to-br from-white to-green-50 rounded-3xl shadow-xl border border-green-100 p-8">
              ...
              <div className="max-w-2xl">
                <div className="bg-white/80 rounded-2xl p-6 border border-green-100 hover:shadow-lg transition-all duration-200">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium transition-colors text-sm shadow-md hover:shadow-lg"
                    >
                      Change Password
                    </button>
                  </div>
