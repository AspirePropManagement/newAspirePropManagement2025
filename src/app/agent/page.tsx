...
/**
 * Agent dashboard page with role-based access control
 * Displays agent-specific information and functionality
 */
            ...
            <div className="flex justify-between items-center py-6">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Welcome back, {user?.first_name || 'Agent'}! Manage your properties and clients.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">Sold Properties</p>
                  <p className="text-2xl font-semibold text-gray-900">0</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              <div className="text-center text-gray-500 py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Start adding properties and managing clients to see your activity here.
                </p>
              </div>
            </div>
          </div>
