...
/**
 * Owner dashboard page with role-based access control
 * Displays owner-specific information and functionality
 */
            ...
            <div className="flex justify-between items-center py-6">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Welcome back, {user?.first_name || 'Owner'}! Manage your properties.
                </p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Add your property for sale or rent</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">View property inquiries and leads</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              <div className="text-center text-gray-500 py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Start listing your properties to see your activity here.
                </p>
              </div>
            </div>
          </div>
