        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">
                  <span className="text-white">ASPIRE</span>
                  <span className="text-orange-500">PROP MANAGEMENT</span>
                </h3>
                <p className="text-sm text-gray-400">NO ONE TARGETS YOUR NEED BETTER</p>
              </div>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted partner in property management and real estate services. 
              We provide comprehensive solutions for buyers, agents, and builders.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/buyer" className="text-gray-300 hover:text-orange-500 transition-colors">
                  Buyer Dashboard
                </Link>
              </li>
              <li>
                <Link href="/agent" className="text-gray-300 hover:text-orange-500 transition-colors">
                  Agent Dashboard
                </Link>
              </li>
              <li>
                <Link href="/builder" className="text-gray-300 hover:text-orange-500 transition-colors">
                  Builder Dashboard
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">info@aspireprop.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                </svg>
                <span className="text-gray-300 text-sm">+91 8080 190190</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
