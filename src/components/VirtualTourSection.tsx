      ...
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200 p-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Explore the property from anywhere with our virtual tours</p>
          </div>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">{virtualContent.length}</div>
            <div className="text-sm text-gray-600">Virtual Tours</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">360°</div>
            <div className="text-sm text-gray-600">Interactive Views</div>
          </div>
          <div className="text-center">
      ...
      {virtualContent.length > 0 ? (
                    ...
                    <div className="aspect-video relative bg-gray-100">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <button
                          ...
                          className="w-16 h-16 bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full flex items-center justify-center transition-all transform group-hover:scale-110"
                        >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Virtual Tours Available</h3>
            <p className="text-gray-500 mb-4">Virtual tours and videos will be available soon.</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <h4 className="font-medium text-gray-900 mb-1">360° View</h4>
            <p className="text-sm text-gray-600">Interactive panoramic views</p>
          </div>
          ...
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <h4 className="font-medium text-gray-900 mb-1">Video Walkthrough</h4>
          ...
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <h4 className="font-medium text-gray-900 mb-1">Drone Footage</h4>
            <p className="text-sm text-gray-600">Aerial property views</p>
          </div>
          ...
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <h4 className="font-medium text-gray-900 mb-1">Floor Plans</h4>
            <p className="text-sm text-gray-600">Interactive layouts</p>
          </div>
        </div>
      </div>
