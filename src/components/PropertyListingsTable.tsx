            ...
            <div className="hidden lg:block overflow-x-auto">
              <table className="w-full text-xs border-collapse">
                <thead className="bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-300">
                  <tr>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">Property</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">Location</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">BHK</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">Price</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">Status</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">Created By</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap border-r border-gray-200">Listed</th>
                    <th className="px-3 py-2.5 text-left text-[10px] font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap">Actions</th>
                  </tr>
                </thead>
                    ...
                    >
                      ...
                      <td className="px-3 py-2.5 border-r border-gray-200 align-middle">
                        <div className="flex items-center space-x-1.5 min-w-0">
                          ...
                          <span className="text-[11px] text-gray-900 truncate">{property.location}</span>
                        </div>
                      </td>
                      <td className="px-3 py-2.5 border-r border-gray-200 align-middle">
                        <span className="text-[11px] font-medium text-gray-900 whitespace-nowrap">{property.bhkType}</span>
                      </td>
                      <td className="px-3 py-2.5 border-r border-gray-200 align-middle">
                        <div className="flex items-center space-x-1">
                          <CurrencyRupeeIcon className="w-3 h-3 text-green-600 flex-shrink-0" />
                          <span className="text-[11px] font-semibold text-green-600 whitespace-nowrap">
                      ...
                      <td className="px-3 py-2.5 border-r border-gray-200 align-middle">
                        <div className="flex items-center space-x-1.5 min-w-0">
                          <div className="w-5 h-5 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <span className="text-[9px] font-semibold text-purple-600">
                              {(property.seller_name || property.owner_name || 'U').charAt(0).toUpperCase()}
                            </span>
                          </div>
                          <div className="min-w-0 flex-1">
                      ...
                      <td className="px-3 py-2.5 border-r border-gray-200 align-middle">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-[11px] text-gray-600 whitespace-nowrap">{formatDate(property.createdAt)}</span>
                        </div>
                      </td>
                ...
                <>
                  ...
                  <div className="col-span-1 sm:col-span-2">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <div>
                          <label className="text-sm font-medium text-gray-700">Loan Available</label>
